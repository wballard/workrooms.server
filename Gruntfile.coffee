    ...
    copy:
      extension:
        files: [
          ...
          {src: '**/*.*', dest: 'build/bower_components/fonts', expand: true, cwd: 'bower_components/font-awesome/fonts'}
          {src: '**/*.*', dest: 'build/bower_components/fonts', expand: true, cwd: 'bower_components/semantic-ui/src/fonts'}
        ]
      tabs:
        files: [
