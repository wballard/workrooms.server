Build ui-tooltip from source into
build/ui-tooltip.html, all streamlined and ready to be included.
...
Vulcanize for the speed.
    ...
    gulp.task 'vulcanize', ['elements'], ->
      built = 'build/ui-tooltip.html'
      gulp.src ''
        .pipe shell([
          "vulcanize --inline --strip -o ui-tooltip.html #{__dirname}/build/*.html"
          ])
