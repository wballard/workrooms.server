Build ui-input from source into
build/ui-input.html, all streamlined and ready to be included.
...
Vulcanize for the speed.
    ...
    gulp.task 'vulcanize', ['elements'], ->
      built = 'build/ui-input.html'
      gulp.src ''
        .pipe shell([
          "vulcanize --inline --strip -o ui-input.html #{__dirname}/build/*.html"
          ])
